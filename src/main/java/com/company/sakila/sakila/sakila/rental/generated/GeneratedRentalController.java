...
public abstract class GeneratedRentalController {
    ...
    protected @Autowired RentalManager manager;
    
    @RequestMapping(value = "/rental", method = GET)
    public List<Rental> get(@RequestParam(value = "start", defaultValue = "0") long start,
