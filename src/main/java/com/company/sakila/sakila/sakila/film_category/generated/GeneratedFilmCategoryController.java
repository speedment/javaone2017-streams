...
public abstract class GeneratedFilmCategoryController {
    ...
    protected @Autowired FilmCategoryManager manager;
    
    @RequestMapping(value = "/filmCategory", method = GET)
    public List<FilmCategory> get(@RequestParam(value = "start", defaultValue = "0") long start,
