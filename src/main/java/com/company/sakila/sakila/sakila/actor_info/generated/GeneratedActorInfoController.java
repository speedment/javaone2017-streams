...
public abstract class GeneratedActorInfoController {
    ...
    protected @Autowired ActorInfoManager manager;
    
    @RequestMapping(value = "/actorInfo", method = GET)
    public List<ActorInfo> get(@RequestParam(value = "start", defaultValue = "0") long start,
