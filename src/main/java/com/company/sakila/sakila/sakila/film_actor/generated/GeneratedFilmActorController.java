...
public abstract class GeneratedFilmActorController {
    ...
    protected @Autowired FilmActorManager manager;
    
    @RequestMapping(value = "/filmActor", method = GET)
    public List<FilmActor> get(@RequestParam(value = "start", defaultValue = "0") long start,
